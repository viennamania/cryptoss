...
export default function Index({ params }: any) {
    ...
    const storecode = "zigle";

    console.log("storecode", storecode);


    const lang = "ko" as string;
    ...
    const acceptSellOrder = (index: number, orderId: string) => {
        ...
        .then(data => {
            ...
            */
            ...
            router.push('/' + "ko" + '/' + storecode + '/pay-usdt/' + orderId);
    ...
    if (dataGetAllSellOrders.result) {
      ...
      if (order) {
        ...
        if (data.result) {
          ...
          //router.push('/' + "ko" + '/' + storecode + '/pay-usdt/' + order._id);
        ...
        if (data.result) {
          ...
          router.push('/' + "ko" + '/home/pay-usdt-reverse/' + order._id);
  ...
  return (
    ...
    <main className="
      ...
      {/* header fixed top position and the width is max-w-screen-sm bg-zinc-50 */}
      <div className="w-full max-w-screen-sm bg-zinc-100
        fixed top-0 center z-50
        ">
        <div className="mt-4 flex flex-row items-center justify-between p-4">
          <Image
            src="/zigle/logos/mainLogo.png"
            alt="Logo"
            width={80}
            height={40}
          />
          <button
            onClick={() => router.push('/' + "ko" + '/' + storecode + '/')}
              ...
              <div className="flex flex-col items-start justify-center gap-2">
                ...
                <div className='flex flex-row gap-2 items-center justify-center'>
                  ...
                  <button
                    ...
                    className="text-sm underline text-zinc-800 hover:text-zinc-600 px-2 py-1 rounded-md border border-zinc-200 hover:bg-zinc-50"
                  >
                                ...
                                <div className='flex flex-row items-center justify-end gap-2'>
                                  <button
                                      ...
                                      onClick={() => {
                                        ...
                                        navigator.clipboard.writeText(`https://stable.makeup/${"ko"}/sell-usdt/${item._id}`);
